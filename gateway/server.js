...
const UPSTREAM_SERVICES = [
  ...
  {
    prefix: '/api/datahub',
    upstream: process.env.DATAHUB_URL || 'http://127.0.0.1:5001',
    rewrite: '/api/v1',
    appCode: 'datahub',
    publicPaths: ['/devices/scanner/auth', '/slices/presign-upload-urls', '/slices/batch-confirm'],
  },
